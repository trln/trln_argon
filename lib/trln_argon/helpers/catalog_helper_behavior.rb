module TrlnArgon
  # Override default BL CatalogHelper
  module CatalogHelperBehavior
    ...
    def page_entries_info(collection, options = {})
      ...
      entry_name = if options[:entry_name]
                   ...
                   elsif collection.respond_to?(:model_name) &&
                         !collection.model_name.nil?
                     # AR, Blacklight::PaginationMethods
      ...
      end_num = if collection.respond_to?(:groups) &&
                   render_grouped_response?(collection)
