module TrlnArgon
  module Fields
    ...
    SUBJECT_CHRONOLOGICAL_FACET = TrlnArgon::Field.new :subject_chronological_f
    SUBJECT_GENRE_FACET         = TrlnArgon::Field.new :subject_genre_f
    SUBJECT_GEOGRAPHIC_FACET    = TrlnArgon::Field.new :subject_geographic_f
    SUBJECT_MEDICAL_FACET       = TrlnArgon::Field.new :subject_medical_f
    SUBJECT_TOPIC_LCSH_FACET    = TrlnArgon::Field.new :subject_topic_lcsh_f
